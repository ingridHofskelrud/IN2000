...
public final class Grib2Json {
    ...
    public Grib2Json(File file, List<Options> optionGroups, File outfile) {
        if (!file.exists()) {
    ...
    private JsonGenerator newJsonGenerator(Options options) throws IOException {
        ...
        OutputStream output = new BufferedOutputStream(new FileOutputStream(this.outFile, false));
